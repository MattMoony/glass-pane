 ...
 * @param res The response object (with `res.locals.organ`).
 */
export const getBioPic = async (req: Request, res: Response): Promise<void> => {
 ...
 * @param res The response object (with `res.locals.organ`).
 */
export const uploadBioPic = async (req: Request, res: Response): Promise<void> => {
  const organ = res.locals.organ as Organ;
 ...
 * @param res The response object (with `res.locals.organ`).
 */
export const getMembershipSources = async (req: Request, res: Response): Promise<void> => {
  const organ = res.locals.organ as Organ;
