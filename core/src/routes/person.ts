...
router.post('/:userId/relation/sources', controller.checkUid, controller.addRelationSource);
router.patch('/:userId/relation/sources/:sourceId', controller.checkUid, controller.updateRelationSource);
router.delete('/:userId/relation/sources/:sourceId', controller.checkUid, controller.removeRelationSource);
